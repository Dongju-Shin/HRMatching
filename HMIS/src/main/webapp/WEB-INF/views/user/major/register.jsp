							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a href="/user/major/list">수강 전공 목록</a></li>
										<li class="breadcrumb-item active">수강 전공 등록</li>
									</ol>
								</div>
								<h4 class="page-title">수강 전공 등록</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
   ...
   //submit 버튼
      $(document).ready(function(){
            ...
            $(".btn-light").on("click", function(){
               ...
               formObj.attr("action", "/user/major/list");
               formObj.submit();
            });
            
            //삭제
            $(".btn-danger").on("click",function() {
                     formObj.attr("action", "/user/major/remove");
